...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<h1 style="font-size: 25px; margin-top: 15px; margin-bottom: 15px; text-align: center;">Subscription Cancelled</h1>
	<div class="section" style="display: block; margin-bottom: 10px;">{{$subscr_num}} – {{$user_full_name}}</div>
	<div class="section" style="display: block; margin-bottom: 10px;">A subscription was just cancelled on Nanny Parent Connection:</div>	
		<table class="transaction" style="clear: both;">
			<tbody>
				...
				<tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">Auto Rebill:</th>
					<td>Stopped</td>
				</tr>
				<tr>

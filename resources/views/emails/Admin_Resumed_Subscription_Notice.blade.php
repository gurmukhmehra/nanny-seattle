...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<h1 style="font-size: 30px; margin-top: 15px; margin-bottom: 15px; text-align: center;">Subscription Resumed</h1>
	<div class="section" style="display: block; margin-bottom: 10px;">{{$subscr_num}} – {{$user_full_name}}</div>
	<div class="section" style="display: block; margin-bottom: 10px;">A user resumed their subscription on Nanny Parent Connection:</div>	

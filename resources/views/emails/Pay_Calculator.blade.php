...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<div id="body" style="width: 600px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
    <h4 style="font-size: 18px; margin-top: 15px; margin-bottom: 15px; text-align: center;">Landing Page - Pay Calculator Form Submission</h4>
	<div></div>

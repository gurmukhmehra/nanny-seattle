...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<h1 style="font-size: 30px; margin-top: 15px; margin-bottom: 15px; text-align: center;">Your Transaction Failed</h1>
	...
	<div class="section" style="display: block; margin-bottom: 10px;">Your transaction with Nanny Parent Connection just failed. Please <a href="{{URL::to('UserDashboard')}}" style="color:#e58eb2;">update your payment details</a> and retry your purchase.</div>
	<div class="section" style="display: block; margin-bottom: 10px;">Here are the details of your transaction:</div>
	<div></div>

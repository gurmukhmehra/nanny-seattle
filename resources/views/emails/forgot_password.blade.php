                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding: 20px; font-family: sans-serif; mso-height-rule: exactly; line-height: 24px; color: #555555; font-size: 15px" class="body_text_color body_text_size">
                                                            <span style="font-weight: bold; font-size: 20px" class="welcome">Hi {{$name}}</span>
                                                            <hr color="#F7F3F0">
                                                            <p>Your forgot password link : <a href="{{ URL::to('/forgot-password/'.encrypt($username)) }}" style="color: #555555;">Click here</a>.</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>

...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<h1 style="font-size: 30px; margin-top: 15px; margin-bottom: 10px; text-align: center;">Your subscription has been downgraded!</h1>
	<div class="section" style="font-size:18px;display: block; text-align: center; margin-bottom: 20px;">Subscriber #:{{$subscription_id}}</div>
	<div class="section" style="display: block; text-align: center; margin-bottom: 20px;">Your subscription with Nanny Parent Connection was downgraded:</div>	

...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<h1 style="font-size: 30px; margin-top: 15px; margin-bottom: 10px; text-align: center;">Subscription Upgraded</h1>
	<div class="section" style="display: block; margin-bottom: 10px;">{{$subscr_num}} – {{$user_full_name}}</div>
	<div class="section" style="display: block; margin-bottom: 10px;">A user upgraded their subscription on Nanny Parent Connection:</div>	

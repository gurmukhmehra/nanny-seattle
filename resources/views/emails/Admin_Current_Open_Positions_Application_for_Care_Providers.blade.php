...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
    ...
    <h4 style="font-size: 18px; margin-top: 15px; margin-bottom: 15px; text-align: center;">Care Provider Candidate Just Applied for Position</h4>
	<div></div>
		<table class="transaction" style="clear: both;">
			<tbody>
				...
				<tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">May we communicate with you via text message? : </th>
					<td>{{$communicate_via_text_message}}</td>
				</tr>
				<tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">Which open position are you most interested in? : </th>
					<td>{{$position_in_interested}}</td>
				</tr>				
			</tbody>
		</table>
	</div>

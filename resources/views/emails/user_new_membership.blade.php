                ...
                <td valign="top">
                    <div style="width: 100%; text-align: left;">
                        <div style="max-width: 900px; margin: auto;" class="email-container">			
                            <table role="presentation" style="border-radius: 5px;margin-top:30px;" class="body_bg" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                <tbody>
                                    <tr>
                                        <td>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding: 20px; font-family: sans-serif; mso-height-rule: exactly; line-height: 24px; color: #555555; font-size: 15px" class="body_text_color body_text_size">
                                                            <span style="font-weight: bold; font-size: 20px" class="welcome">Hi {{$name}}, Thanks for buy membership.</span>
                                                            <hr color="#F7F3F0">
                                                            <p>Membership Details : </p>
                                                            <p>Membership Name : {{$membership}} </p>
                                                            <p>Period : ${{$membership_price}}/{{$membership_period}} </p>
                                                            <p>Visit your <a href="{{URL::to('/login')}}" style="color: #555555;">profile</a>, where you can tell us more about yourself, change your preferences, or make new connections, to get started.</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>

...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
    ...
    <div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        <div class="section" style="display: block; margin-bottom: 10px;margin-top:15px;">Hi {{$user_first_name}},</div>
         <p>Just a friendly reminder that your Learning Guide© membership with Nanny Parent Connection renews in 30 days.</p>
        <p>If you would like to continue having premium access to...</p>

        <ul>
            <li class="section">Our amazing Learning Guides© Service</li>            
            ...
            <li>all of the other tools available on our <a href="{{URL::to('/')}}" style="color: #e58eb2;">website</a> and within our Facebook communities</li>
            <li>and most importantly, <a href="mailto:laura@nannyparentconnection.com" style="color: #e58eb2;">personal support from our expert team</a></li>
        </ul>
        <p>... there is nothing that you need to do at this time. Your membership will automatically renew in 30 days.</p>
        <p>If you would like to cancel your membership, <a href="{{URL::to('help')}}" style="color: #e58eb2;">click this link</a> and follow the instructions. If you have any questions, just reply to this email or shoot me a call or text at <a href="tel:(425) 243-7032" style="color: #e58eb2;">(425) 243-7032</a>!</p>

        <p>Thanks for being an important part of our community!</p>
        <p>Laura Scoccolo</p>

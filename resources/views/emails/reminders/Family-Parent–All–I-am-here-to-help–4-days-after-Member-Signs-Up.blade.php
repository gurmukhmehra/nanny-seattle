...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
    ...
    <div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        ...
        <p>Laura from Nanny Parent Connection here.</p>
        <P>I hope that by now, you have found several care providers that you are interested in working with.</p>
        <P>If not or if you are having trouble making a "connection", let me know! I am more than happy to help. Just reply to this email or shoot me a call/text at <a href="tel:(425) 243-7032" style="color: #e58eb2;">(425) 243-7032</a> and tell me what I can do for you.</p>
        <P>Cheers!</p>
        <P>Laura Scoccolo</p>
        <P>Founder and "Chief Mommy"</p>
        <P>P.S. Don't forget that you can browse nanny and babysitter profiles with our <a href="{{URL::to('member-search')}}" style="color: #e58eb2;">Member Search</a> tool. You will also see Suggested Matches that our system has picked out for you on that same page!</p>
    </div>

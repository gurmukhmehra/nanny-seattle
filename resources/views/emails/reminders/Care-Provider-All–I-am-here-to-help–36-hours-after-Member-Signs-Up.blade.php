...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
	...
	<div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        ...
        <P>I hope that by now, you have found several families that you are interested in working with.</p>
        ...
        <P>P.S. Don't forget that you can browse family/parent profiles with our <a href="{{URL::to('member-search')}}" style="color: #e58eb2;">Member Search</a> tool. You will also see Suggested Matches that our system has picked out for you on that same page!
        </p>
    </div>

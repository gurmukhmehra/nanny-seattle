...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
    ...
    <div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        ...
        <P>Just a friendly reminder that your membership to the Nanny Parent Connection expires in a few minutes.</p>
        <P>I don't want you to lose access to our Facebook communities and all of the tools available on our website like our Last Minute Care Service so make sure you renew today.</p>
        <P><a href="{{URL::to('UserDashboard')}}" style="color: #e58eb2;">Click here to renew your access.</a></p>
        <P>Reply to this email if you need any help or have a question or shoot me a call or text at <a href="tel:(425) 243-7032" style="color: #e58eb2;">(425) 243-7032</a>. I'm available from 9am to 9pm PST every day of the week.</p>
        <P>Cheers!</p>
        <P>Laura Scoccolo</p>

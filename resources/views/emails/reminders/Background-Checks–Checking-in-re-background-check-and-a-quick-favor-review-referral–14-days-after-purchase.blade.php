...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
    ...
    <div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        ...
        <P>About two weeks ago, you purchased one of our background checks. By now, you probably have received the completed background check report via email. How did our background check system work for you? Was there anything you felt could be improved?</p>
        <P>If you haven't received the report yet, please respond to this email or shoot me a call or text at <a href="tel:(425) 243-7032" style="color: #e58eb2;">(425) 243-7032</a> and I will check on the order status. We may be still waiting for specific government agencies to fulfill our information request.</p>
        ...
        <P><strong><a href="https://www.yelp.com/biz/nanny-parent-connection-seattle" style="color: #e58eb2;">CLICK HERE TO LEAVE A YELP REVIEW</a> OR <a href="https://g.page/nanny_parent_connection/review?rc" style="color: #e58eb2;">HERE TO LEAVE A GOOGLE REVIEW </a></strong></p>
        <P>One last thing, if you have a friend or associate you think might be interested in our background checks, please sign up for our Rewards Program and pass the word! You can earn credit or Paypal™️ cash if they order a background check!</a></p>
        <P>Best wishes!</p>
        <P>Laura Scoccolo</p>

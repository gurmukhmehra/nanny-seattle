...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
    ...
    <div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        ...
        <ul>
            <li class="section">Our online community of over 10,000 parents and families looking to connect with care providers like you</li>
            <li><a href="{{URL::to('last-minute-group-text')}}" style="color: #e58eb2;">Last Minute Care Text Service</a> - receive text messages when a parent in your area needs last minute care</li>
            <li><a href="{{URL::to('verified-care-providers')}}" style="color: #e58eb2;">Verified Care Provider Service</a></li>

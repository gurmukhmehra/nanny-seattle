...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
    ...
    <div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        ...
        <P>I hope that you found that special "Mary Poppins" care provider to work with. If so, GREAT! I am glad that the Nanny Parent Connection was able to help you with your child care opportunity. If you have two minutes, my team and I would very much appreciate it if you could leave us a positive review. As a small company, we rely on word of mouth (and reviews from parents like you) to promote Nanny Parent Connection in our community. <a href="https://www.yelp.com/biz/nanny-parent-connection-seattle" style="color: #e58eb2;">Click here to leave a Yelp review</a> or <a href="https://g.page/nanny_parent_connection/review?rc" style="color: #e58eb2;">here to leave a Google review</a>!!</p>
        ...
        <P>If you found our services useful and think your friends might as well, don't forget to check out our Rewards Program. You can earn cash or credits when someone in your network signs up!</p>

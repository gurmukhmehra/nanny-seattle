...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
    ...
    <div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        ...
        <P>Just a friendly reminder that your access to our website and Facebook communities ends in a few days.</p>
        <P>I wouldn't want you to miss out so make sure you<strong> <a href="{{URL::to('membership')}}" style="color: #e58eb2;">renew your access</a></strong>. Reply to this email if you need any help or have a question or shoot me a call/text at <a href="tel:(425) 243-7032" style="color: #e58eb2;">(425) 243-7032!</a></p>
        <P>Cheers!</p>
        <P>Laura Scoccolo</p>
        <P>Founder and "Chief Mommy"</p>
        <p>P.S. Don't forget that our Search Team is standing by if you need any help!</p>
    </div>

...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;">
    ...
    <div id="body" style="width: 800px; background: white; padding: 0px; margin: 0 auto; text-align: left;">
        ...
        <P>I noticed that you began the process of ordering a background check a few hours ago but weren't able to finish. Our background checks are some of the most affordable yet complete background checks available in the United States today!</p>
        ...
        <P>If you would like to return to the background check portal to complete your order, <a href="{{URL::to('background-checks')}}" style="color: #e58eb2;">click here</a>.</p>
        <P>My team is available 7 days per week, 365 days per year to help you with your background check questions.</p>

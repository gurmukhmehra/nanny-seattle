...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<h1 style="font-size: 30px; margin-top: 15px; margin-bottom: 15px; text-align: center;">Transaction Failed</h1>
	<div class="section" style="display: block; margin-bottom: 10px;">{{$trans_num}} – {{$user_full_name}}</div>
	<div class="section" style="display: block; margin-bottom: 10px;">A transaction just failed on Nanny Parent Connection:</div>	

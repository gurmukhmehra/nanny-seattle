                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding: 20px; font-family: sans-serif; mso-height-rule: exactly; line-height: 24px; color: #555555; font-size: 15px" class="body_text_color body_text_size">
                                                            <span style="font-weight: bold; font-size: 20px" class="welcome">{{$FriendAcceptedByName}} accepted your friend request..</span>
                                                            <hr color="#F7F3F0">
                                                            <p>To learn more about them, visit their profile: <a href="{{URL::to('/member-friends')}}" style="color: #555555;">{{URL::to('member-friends')}}</a></p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>

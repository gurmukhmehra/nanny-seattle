...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
	...
	<h1 style="font-size: 30px; margin-top: 15px; margin-bottom: 15px; text-align: center;">New One-Time Subscription</h1>
	...
	<div class="section" style="display: block; margin-bottom: 10px;">A non-recurring subscription was just created on Nanny Parent Connection:</div>	

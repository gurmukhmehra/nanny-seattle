...
<body style="font:13px 'Lucida Grande','Lucida Sans Unicode',Tahoma,Verdana,sans-serif;color:#545454;"> 
    ...
    <h4 style="font-size: 18px; margin-top: 15px; margin-bottom: 15px; text-align: center;">Family Just Filled Out Concierge Service Initial Intake Form - Please Follow Up With!</h4>
	<div></div>
		<table class="transaction" style="clear: both;">
			<tbody>
				...
				<tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">Email Confirmation : </th>
					<td>{{$Email_Confirmation}}</td>
				</tr>
				<tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">What city and neighborhood do you live in? : </th>
					<td>{{$city_live_in}}</td>
				</tr>
				<tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">How did you hear about our Concierge Service? : </th>
					<td>{{$Concierge_Service}}</td>
				</tr>
				<tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">Ideal start date? : </th>
					<td>{{$Ideal_start_date}}</td>
				</tr>
                <tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">Is your start date flexible? : </th>
					<td>{{$date_flexible}}</td>
				</tr>
                <tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">How long will this position last, if known? : </th>
					<td>{{$position_last}}</td>
				</tr>
                <tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">Days and times care is needed during the week? : </th>
					<td>{{$Days_and_times}}</td>
				</tr>
                <tr>
					<th style="text-align: left;font-size: 14px;color: #4f5255;">Number of children and ages of children when care begins? : </th>

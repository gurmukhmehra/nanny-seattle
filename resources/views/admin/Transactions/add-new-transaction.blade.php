    ...
    <div class="row page-titles mx-0">        
        <div class="col-sm-6 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Add New Transaction</a></li>
            </ol>
        </div>  
        ...
        <div class="col-lg-12">
            <div class="card" style="background-color:#B3ABAB47;">                
                <div class="card-body">                     
                    ...
                    {{ Form::open(array('url' => 'superadmin/transaction/add-new' , 'autocomplete'=>'off', 'enctype' =>'multipart/form-data')) }}
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <label style="color:#333;">Transaction Number<sup class="text-danger">*</sup></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="username" required value="" class="form-control findUsername">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-control" required name="product_id">
                                    @foreach($memberships as $membership)
                                        <option value="{{$membership->id}}">{{$membership->post_title}}</option>
                                    @endforeach                                
                                </select>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="sub_total" required value="0.00" class="form-control">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="tax_amount" required value="0.000" class="form-control">
                                <small>The amount of taxes for this transaction</small>
                            </div>
                            <div class="col-md-4">
                                <label style="color:#333;">Tax Rate<sup class="text-danger">*</sup></label>
                                <input type="text" name="tax_rate" required value="0.000" class="form-control">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="subscription_id" value="0" class="form-control">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="created_at" readonly value="{{$time_date_now}}" class="form-control">
...
@push('scripts')
    <script>
        ...
        //     $('.test').text('We are working on..').css('color','red');
        //     setTimeout(function() {
        //         $(".test").text('');
        //     }, 5000);
        // });    

<div class="nav-header">
    ...
    <a href="{{URL::to('/')}}" Target="_blank" class="brand-logo text-dark">
...
<!--**********************************Header start***********************************-->
<div class="header">
	<div class="header-content" style="background-color:#B3ABAB47;">
		<nav class="navbar navbar-expand">
			<div class="collapse navbar-collapse justify-content-between">
				<div class="header-left">
					<div class="search_bar dropdown show d-none">
				...
				<ul class="navbar-nav header-right">
					...
					<li class="nav-item dropdown header-profile">
						<a class="nav-link" href="#" role="button" data-toggle="dropdown">
							...
							<img src="{{ URL::asset('/public/uploads/profileImage/'.Auth::user()->profileImage) }}" width="20" alt=""/>
						</a>
						<div class="dropdown-menu dropdown-menu-right">
							<a href="{{URL::to('superadmin/profile')}}" class="dropdown-item ai-icon">
								<svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
								<span class="ml-2">Profile </span>
							</a>
							<a href="{{URL::to('superadmin/change-password')}}" class="dropdown-item ai-icon">
								<span class="ml-0"><i class="flaticon-381-key mr-2" style="color:#000;"></i> Password </span>
							</a>
							
							<a href="{{URL::to('superadmin/logout')}}" class="dropdown-item ai-icon">

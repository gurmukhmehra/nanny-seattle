    ...
    <div class="row page-titles mx-0">        
        <div class="col-sm-6 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add New Help</a></li>
            </ol>
        </div>  
            ...
            <div class="card" style="background-color:#B3ABAB47;">                
                <div class="card-body"> 
                    <div class="card-header pt-0 pl-0">
                        <h5 class="card-title">Add New Help </span></h5>
                    ...
                    {{ Form::open(array('url' => 'superadmin/helps/add' , 'autocomplete'=>'off', 'enctype' =>'multipart/form-data')) }}
                        <div class="row mt-4"> 
                            <div class="col-md-6">                           
                             ...
                             <label style="color:#333;">Category</label>
                                <select class="form-control" name="help_category">
                                    @foreach($helpCats as $helpCat)
                                        <option value="{{$helpCat->id}}">{{$helpCat->category_title}}</option>
                                    @endforeach
                                </select>
                            </div> 
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <textarea name="post_content" required class="form-control ckeditor"></textarea>
                            </div>
                        </div>
